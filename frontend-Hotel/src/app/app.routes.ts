...
import { Delete as HotelDelete } from './components/Hotel/delete/delete';import { Getall as TipoHabitacionGetall } from './components/TipoHabitacion/getall/getall';
...
import { Delete as TipoHabitacionDelete } from './components/TipoHabitacion/delete/delete';import { Getall as HabitacionGetall } from './components/Habitacion/getall/getall';
...
import { Delete as HabitacionDelete } from './components/Habitacion/delete/delete';import { Getall as TemporadaGetall } from './components/Temporada/getall/getall';
...
import { Delete as TemporadaDelete } from './components/Temporada/delete/delete';import { Getall as TarifaGetall } from './components/Tarifa/getall/getall';
...
import { Delete as TarifaDelete } from './components/Tarifa/delete/delete';import { Getall as ClienteGetall } from './components/Cliente/getall/getall';
...
import { Delete as ClienteDelete } from './components/Cliente/delete/delete';import { Getall as ServicioGetall } from './components/Servicio/getall/getall';
...
import { Delete as ServicioDelete } from './components/Servicio/delete/delete';import { Getall as ReservaGetall } from './components/Reserva/getall/getall';
...
import { Delete as ReservaDelete } from './components/Reserva/delete/delete';import { Getall as PagoGetall } from './components/Pago/getall/getall';
...
export const routes: Routes = [
    ...
    { path: 'Hotel/delete/:id', component: HotelDelete, canActivate: [authGuard] },    { path: 'TipoHabitacion', component: TipoHabitacionGetall, canActivate: [authGuard] },
    ...
    { path: 'TipoHabitacion/delete/:id', component: TipoHabitacionDelete, canActivate: [authGuard] },    { path: 'Habitacion', component: HabitacionGetall, canActivate: [authGuard] },
    ...
    { path: 'Habitacion/delete/:id', component: HabitacionDelete, canActivate: [authGuard] },    { path: 'Temporada', component: TemporadaGetall, canActivate: [authGuard] },
    ...
    { path: 'Temporada/delete/:id', component: TemporadaDelete, canActivate: [authGuard] },    { path: 'Tarifa', component: TarifaGetall, canActivate: [authGuard] },
    ...
    { path: 'Tarifa/delete/:id', component: TarifaDelete, canActivate: [authGuard] },    { path: 'Cliente', component: ClienteGetall, canActivate: [authGuard] },
    ...
    { path: 'Cliente/delete/:id', component: ClienteDelete, canActivate: [authGuard] },    { path: 'Servicio', component: ServicioGetall, canActivate: [authGuard] },
    ...
    { path: 'Servicio/delete/:id', component: ServicioDelete, canActivate: [authGuard] },    { path: 'Reserva', component: ReservaGetall, canActivate: [authGuard] },
    ...
    { path: 'Reserva/delete/:id', component: ReservaDelete, canActivate: [authGuard] },    { path: 'Pago', component: PagoGetall, canActivate: [authGuard] },
