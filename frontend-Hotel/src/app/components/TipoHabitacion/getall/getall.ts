...
import { RoomTypeService } from '../../../services/TipoHabitacion.service';
import { RoomTypeResponseI } from '../../../models/TipoHabitacion';

@Component({
  selector: 'app-TipoHabitacion-getall',
  standalone: true,
  imports: [
    CommonModule,
    RouterModule,
...
export class Getall implements OnInit, OnDestroy {
  TipoHabitacion: RoomTypeResponseI[] = [];
  loading: boolean = false;
  private subscription = new Subscription();

  constructor(
    private TipoHabitacionService: RoomTypeService,
    ...
    this.subscription.add(
      this.TipoHabitacionService.getAll().subscribe({
        next: (data) => {
          ...
          this.TipoHabitacionService.updateLocalData(data);
          this.loading = false;
        },
        error: (error) => {
