...
echo -e "${CYAN}Instalando drivers de base de datos y sus tipos (oracledb, tedious)...${NC}"
npm install oracledb tedious
npm install -D @types/oracledb @types/tedious
echo -e "${GREEN}✅ Drivers y tipos instalados.${NC}"
